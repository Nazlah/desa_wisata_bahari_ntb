...
<head>
  ...
  <link rel="preload" href="./assets/home/assets/css/fonts/urbanist.css" as="style" onload="this.rel='stylesheet'">
</head>
...
<body>
  <div class="content-wrapper">
        ...
        <div class="container flex-lg-row flex-nowrap align-items-center">
          ...
          <div class="navbar-collapse offcanvas offcanvas-nav">
            <div class="offcanvas-header d-lg-none d-xl-none">
              <a href="./index.html"><img src="./assets/home/assets/img/logo-light.png" srcset="./assets/home/assets/img/logo-light@2x.png 2x" alt="" /></a>
            ...
            <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-lg-none">
                        <span><a href="{{ route('login') }}" class="btn btn-sm btn-gradient gradient-1 rounded d-lg-none" style="width: 100%; margin-top: 1rem;">Login</a></span>
                    </li>
                </ul>
              <!-- /.navbar-nav -->
          ...
          <div class="navbar-other w-100 d-flex ms-auto">
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item d-none d-lg-block"><span><a href="{{ route('login') }}"  target="_blank" class="btn btn-sm btn-gradient gradient-1 rounded">Login</a></span></li>
              <li class="nav-item d-lg-none">
    ...
    <section class="wrapper bg-light">
      <div class="container-card">
        <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-light-500 mt-2 mb-5" data-image-src="./assets/home/assets/img/photos/bg22.png">
          <div class="card-body py-14 px-0">
            <div class="container">
              <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center text-center text-lg-start">
                ...
                <!--/column -->
                <div class="col-lg-6">
                  <img class="img-fluid mb-n18" src="./assets/home/assets/img/illustrations/3d6.png" srcset="./assets/home/assets/img/illustrations/3d6@2x.png 2x" data-cue="fadeIn" data-delay="300" alt="" />
                </div>
                <!--/column -->
              </div>
              <!-- /.row -->
  ...
  <footer class="bg-light">
    <div class="container-card">
      <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-light-500 mb-14" data-image-src="./assets/home/assets/img/photos/bg22.png">
